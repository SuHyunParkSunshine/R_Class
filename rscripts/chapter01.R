...
# R Session 보기 => R 개발환경 알려 줄 때
sessionInfo()

# 실습: stringr 패키지 설치 => 문자열
...
# 실습: '변수.멤버' 형식의 변수 선언(객체의 setter와 비슷한 형식)
goods.code <= 'a001'
goods.name <- '냉장고'
goods.price <- 850000
...
sum(10, 20, 20)
sum(10, 20, 20, NA)
sum(10, 20, 20, NA, na.rm = TRUE) #'na.rm = TRUE' => python pandas에서의 pass
ls()
